...
export const unPaidInvoicesController = async (req,res) => {
    const { id } = req.query;
    try{
        ...
        if(count[0].count+"" !== "0"){
            fulfillment = `Your have ${count[0].count} unpaid invoices and details are as follows.\n\n`;
            ...
            fulfillment = `Your do not have any unpaid invoices.`;
